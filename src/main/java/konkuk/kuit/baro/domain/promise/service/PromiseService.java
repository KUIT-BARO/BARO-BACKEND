...
public class PromiseService {
    ...
    // 약속 현황 조회 - 투표중
    public VotingPromiseResponseDTO getVotingPromise(Long promiseId, Boolean isHost) {
        Promise findPromise = findPromise(promiseId);
        ...
        if (isHost) {
            return new VotingPromiseResponseDTO(promiseName, canCloseVoting(findPromiseVote.getId()), promiseMemberVoteState);
        }

        return new VotingPromiseResponseDTO(promiseName, null, promiseMemberVoteState);
    }
