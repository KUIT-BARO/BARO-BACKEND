...
public class PlaceController {
    ...
    @GetMapping
    public BaseResponse<List<PlacesResponseDTO>> placeSearch(@RequestParam("latitude") Double latitude,
                                                             @RequestParam("longitude") Double longitude
    ) {
        return BaseResponse.ok(placeService.placeSearch(latitude, longitude));
    }
}
